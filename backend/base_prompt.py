...
ALWAYS start by searching the web for "[都市名] airport IATA code" to find ALL airports serving that city.
This is MANDATORY — do NOT skip this step, do NOT use airport codes from your training data.
Example search: "Bangkok airports IATA code", "London airports IATA code"
