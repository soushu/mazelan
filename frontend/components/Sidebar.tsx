              ...
              >
                {editingId === s.id ? (
                  ...
                  <>
                    ...
                    <span className="group/title relative flex-1 text-sm truncate">
                      {s.title}
                      <span className="pointer-events-none absolute left-0 top-full mt-1 z-50 hidden group-hover/title:block max-w-[240px] whitespace-normal break-words rounded-lg bg-theme-surface border border-border-primary shadow-lg px-3 py-2 text-xs text-t-secondary">
                        {s.title}
                      </span>
                    </span>
